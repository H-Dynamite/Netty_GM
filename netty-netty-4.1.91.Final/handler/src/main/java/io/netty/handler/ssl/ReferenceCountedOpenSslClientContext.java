...
public final class ReferenceCountedOpenSslClientContext extends ReferenceCountedOpenSslContext {
    ...
    static OpenSslSessionContext newSessionContext(ReferenceCountedOpenSslContext thiz, long ctx,
        ...
        try {
            ...
            // to ensure that when the TrustManager throws we will produce the correct alert
            // back to the server.
            //
            // See:
    ...
    static OpenSslSessionContext newSessionContext(ReferenceCountedOpenSslContext thiz, long ctx,
            OpenSslEngineMap engineMap,
            String[] trustCerts,
            GMCertEntry encCert, GMCertEntry signCert,String caCertPath, String keyPassword) throws SSLException {
        /**
