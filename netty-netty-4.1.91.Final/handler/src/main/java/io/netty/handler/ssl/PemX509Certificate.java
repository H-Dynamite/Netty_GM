...
/**
 * This is a special purpose implementation of a {@link X509Certificate} which
 * allows
 * the user to pass PEM/PKCS#8 encoded data straight into {@link OpenSslContext}
 * without
...
public final class PemX509Certificate extends X509Certificate implements PemEncoded {
    ...
    /**
     * Appends the {@link X509Certificate} value to the {@link ByteBuf} (last arg)
     * and returns it.
     * If the {@link ByteBuf} didn't exist yet it'll create it using the
     * {@link ByteBufAllocator}.
     */
