 ...
 * {@link ReferenceCountedOpenSslClientContext}.
 */
public final class OpenSslClientContext extends OpenSslContext {
     ...
     *                                the {@link javax.net.ssl.KeyManager}s
    ...
    OpenSslClientContext(String[] trustCerts, GMCertEntry encCert, GMCertEntry signCert,String caCertPath, String keyPassword,
        ...
        boolean success = false;
        try {
            sessionContext = newSessionContext(this, ctx, engineMap, trustCerts, encCert, signCert,caCertPath,keyPassword);
            success = true;
        } finally {
            if (!success) {
                release();
